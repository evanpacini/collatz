// Collatz 3n+1 steps percentage calculation with memoisation, openmp multithreading, bitwise operations (with reduced /2), and csv export
...
#pragma omp parallel for
    ...
    //Export to csv
    std::ofstream csv("csv/collatz3n+1p.csv", std::ofstream::out);
